...
// Enhanced testimonials with more authentic voice for मुल्तानी पंसारी
const testimonials = [
  {
    name: "राहुल शर्मा",
    location: "दिल्ली",
    ...
    daysUsed: 45,
    text: "मुल्तानी पंसारी का असली चेहरा यहीं दिखता है। Sthul Ghatak ने मेरा वज़न 8kg कम किया 2 महीने में। पहले जिम में पसीना बहाता था, कोई फर्क नहीं पड़ता था। लेकिन ये आयुर्वेदिक फॉर्मूला एकदम रामबाण साबित हुआ। मेटाबॉलिज्म इतना तेज हुआ कि बिना डाइटिंग के ही weight loss हो गया। दादी के नुस्खों जैसा असली स्वाद, कोई मिलावट नहीं। मुल्तानी पंसारी वालों ने हमारे बुजुर्गों की विरासत को सही मायने में जिंदा रखा है।",
  ...
  },
  {
    ...
    product: "Consti-Pi",
    daysUsed: 30,
    text: "सुबह-सुबह पेट साफ न होना मेरी रोज की परेशानी थी। Consti-Pi ने वो परेशानी खत्म कर दी। तीसरे दिन से ही ऐसा feel आया जैसे कोई रुकावट हट गई हो। अब बिना tension के चाय पी सकती हूं। Taste थोड़ा कड़वा है, लेकिन काम ऐसा करता है कि उंगलियां चाटते रह जाओ। मुल्तानी पंसारी का हर product सोने पर सुहागा है।",
  ...
  },
  {
    ...
    daysUsed: 60,
    text: "उम्र के इस पड़ाव पर energy कम होना आम बात है। लेकिन Vajra Vardhak ने मुझे 10 साल जवान कर दिया। सुबह उठते ही चुस्ती-फुर्ती, दिनभर थकान नहीं। रिश्तों में भी वो बात आ गई है। बस धैर्य रखना पड़ता है, जल्दबाजी नहीं करनी। मुल्तानी पंसारी के लोग सच में बाबा जी की विरासत को संभाले हुए हैं।",
  ...
  },
  {
    ...
    daysUsed: 90,
    text: "मेरे बाल तो जैसे मर ही गए थे। शादी के बाद झड़ते ही झड़ते गंजेपन की कगार पर आ गई थी। Kesh Amrit Oil ने जान डाल दी। 3 महीने में नए बाल आने लगे, झड़ना बंद हुआ। अब तो लोग पूछते हैं कौन सा तेल लगाती हो। मुल्तानी पंसारी की हर बूटी में जादू है।",
  ...
  },
  {
    ...
    daysUsed: 25,
    text: "IT सेक्टर में बैठे-बैठे कमर और घुटनों ने दर्द देना शुरू कर दिया था। Pain Zero Oil ने वहीं राहत दी जहां मलहम-पेनकिलर फेल हो गए थे। सुबह-शाम मालिश करो, दर्द भूल जाओ। असली चीज़ है यार, मुल्तानी पंसारी ने दिल जीत लिया।",
  ...
  },
  {
    ...
    daysUsed: 120,
    text: "डायबिटीज ने खाने-पीने का मजा खत्म कर दिया था। Madhu Vinashi ने वो मजा लौटा दिया। 4 महीने में sugar level normal रहने लगा। दवाइयां भूल गई, सिर्फ यही लेती हूं। कोई केमिकल नहीं, बिल्कुल शुद्ध आयुर्वेद। मुल्तानी पंसारी वाले सच में लोगों की भलाई सोचते हैं।",
  ...
  },
  {
    ...
    daysUsed: 45,
    text: "इम्यूनिटी इतनी कमजोर हो गई थी कि हर मौसम में बीमार। Swarn Shakti ने चुटकियों में दुरुस्त कर दिया। अब मौसम बदले या न बदले, मैं हूं कि फिट हूं। मुल्तानी पंसारी का हर product सोने पर सुहागा है। बाबा जी की कृपा से ये बूटियां हम तक पहुंच रही हैं।",
  ...
  },
  {
    ...
    daysUsed: 60,
    text: "बच्चों को च्यवनप्राश खिलाना कोई आसान काम नहीं। लेकिन मुल्तानी पंसारी वालों का च्यवनप्राश इतना स्वादिष्ट है कि बच्चे खुद मांगकर खाते हैं। एनर्जी दिनभर बनी रहती है, सर्दी-खांसी गायब। असली देसी नुस्खा, कोई मिलावट नहीं।",
  ...
  },
  {
    ...
    product: "Power Grow",
    daysUsed: 35,
    text: "थकान तो जैसे मेरी जिंदगी का हिस्सा बन गई थी। Power Grow ने वो थकान दूर कर दी। अब ऑफिस के बाद भी बच्चों के साथ खेलने की energy है। मुल्तानी पंसारी का हर पैसा वसूल है।",
  ...
  },
  {
    ...
    product: "Sthul Ghatak",
    daysUsed: 90,
    text: "प्रेग्नेंसी के बाद बढ़ा वजन कम नहीं हो रहा था। Sthul Ghatak ने चमत्कार कर दिया। 3 महीने में 12kg कम हुआ। अब वही पुरानी फिटनेस लौट आई। मुल्तानी पंसारी ने मेरा कॉन्फिडेंस वापस दिया।",
  ...
  },
  {
    ...
    product: "Vajra Vardhak",
    daysUsed: 50,
    text: "40 के बाद सब कुछ slow होने लगा था। Vajra Vardhak ने फिर से वो speed दी। वर्कआउट में पहले से ज्यादा energy, रिकवरी भी तेज। मुल्तानी पंसारी का हर product जड़ी-बूटियों का खजाना है।",
  ...
  },
  {
    ...
    product: "Kesh Amrit Oil",
    daysUsed: 120,
    text: "डैंड्रफ और हेयर फॉल से परेशान थी। Kesh Amrit Oil ने दोनों का सफाया कर दिया। अब बाल घने और लंबे, चमक ऐसी कि लोग पूछें। मुल्तानी पंसारी के तेल का कोई तोड़ नहीं।",
  ...
  },
  {
    ...
    product: "Swarn Shakti",
    daysUsed: 80,
    text: "बाबा जी के आशीर्वाद से मुल्तानी पंसारी के products मिले। Swarn Shakti ने मेरी इम्यूनिटी इतनी मजबूत कर दी कि कोरोना काल में भी नहीं हुआ। असली सोना है ये कंपनी।",
  ...
  },
  {
    ...
    product: "Consti-Pi",
    daysUsed: 20,
    text: "पेट की गंदगी साफ होते ही चेहरे पर ग्लो आ गया। Consti-Pi ने मेरी skin की चमक लौटा दी। पहले पिम्पल्स थे, अब गायब। मुल्तानी पंसारी का हर product skin के लिए वरदान है।",
  ...
  },
  {
    ...
    product: "Pain Zero Oil",
    daysUsed: 15,
    text: "गठिया का दर्द सालों से था। Pain Zero Oil ने 15 दिन में राहत दी। अब बिना दर्द के चल पाता हूं। मुल्तानी पंसारी के लोग सच्चे सेवक हैं।",
  ...
  },
  {
    ...
    product: "Madhu Vinashi",
    daysUsed: 180,
    text: "6 महीने से Madhu Vinashi ले रही हूं। शुगर पूरी तरह कंट्रोल में है। डॉक्टर भी हैरान हैं कि कैसे बिना दवा के शुगर नॉर्मल रहता है। मुल्तानी पंसारी ने मेरी जिंदगी बदल दी।",
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-white font-body text-sm tracking-wider">
              मुल्तानी पंसारी ट्रस्टेड रिव्यू
            </span>
          </div>
          ...
          <p className="font-body text-muted-foreground text-lg leading-relaxed">
            मुल्तानी पंसारी को जिन लोगों ने अपनाया, उन्होंने सिर्फ product नहीं खरीदा – 
