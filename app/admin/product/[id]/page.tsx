...
export default function ProductUpdateForm() {
  ...
  if (['topRated', 'topSelling'].includes(name)) {
    ...
    <form onSubmit={handleSubmit} className="max-w-7xl mx-auto p-6 grid grid-cols-12 gap-6">
      ...
      <div className="col-span-4 space-y-6 sticky top-6">
        ...
        <div className="border p-3 rounded bg-gray-50 text-sm">
         ...
         {/* TOP RATED & TOP SELLING - ADDED HERE */}
        <div className="bg-white border rounded p-5 space-y-4">
          ...
          <label className="flex items-center gap-3 cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-gray-500">Mark as top rated product</span>
            </div>
          </label>
          ...
          <label className="flex items-center gap-3 cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-gray-500">Mark as best seller</span>
            </div>
          </label>
        </div>
