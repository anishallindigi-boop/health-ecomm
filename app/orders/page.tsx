        ...
        <Card className="overflow-hidden shadow-xl border-0">
          ...
          <div className="p-8">
            ...
            <div className="space-y-6 mb-8">
              <h3 className="text-lg font-semibold flex text-primary items-center gap-2">
                <Package className="w-5 h-5 text-primary" />
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Shipping Address */}
              <div>
                <h3 className="text-lg font-semibold mb-4 flex text-primary items-center gap-2">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="gap-2 text-muted-foreground">
                <Link href="/">
                  <Home className="w-4 h-4" />
                  Continue Shopping
                </Link>
              </Button>
              <Button variant="outline" asChild size="lg" className="gap-2 border-primary border-2 text-primary">
