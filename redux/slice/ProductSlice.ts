...
interface ProductState {
  ...
  isDeleted: boolean;
    suggestions: Product[]; // ✅ ADD THIS
      fetched: boolean; // ✅ ADD THIS FLAG
  adminFetched: boolean; // ✅ ADD THIS FOR ADMIN PRODUCTS
  categoryProductsFetched: Record<string, boolean>; // ✅ FOR CATEGORY-SPECIFIC FETCHES
}
...
const initialState: ProductState = {
  ...
  adminFetched: false, // ✅ ADD THIS
  categoryProductsFetched: {}, // ✅ ADD THIS
};
...
export const ProductSlice = createSlice({
  ...
  reducers: {
    ...
    resetState: (state) => {
      ...
      state.adminFetched = false; // ✅ Reset admin fetched flag
      state.categoryProductsFetched = {}; // ✅ Reset category fetched flags
    },
        resetFetched: (state) => {
      state.fetched = false;
    },
    // ✅ Add a reducer to reset admin fetched flag
    resetAdminFetched: (state) => {
      state.adminFetched = false;
    },
    // ✅ Add a reducer to reset category fetched flag for a specific slug
    resetCategoryFetched: (state, action: PayloadAction<string>) => {
      delete state.categoryProductsFetched[action.payload];
    },
  },
